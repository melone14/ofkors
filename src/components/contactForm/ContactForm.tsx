    ...
    <>
      ...
      >
        <div className="w-[20rem] md:w-full p-10">
          ...
          <span>
            ...
            jest Dariusz Czajka. Dane są lub mogą być przetwarzane w&nbsp;celach
            oraz na podstawach wskazanych szczegółowo w&nbsp;polityce
            prywatności (np. realizacja umowy, marketing bezpośredni). Polityka
            prywatności zawiera pełną informację na temat przetwarzania danych
            przez administratora wraz z&nbsp;prawami przysługującymi osobie,
            której dane dotyczą. Szybki kontakt z&nbsp;administratorem:
            d.czajka@ofkors.pl
          </span>
        </div>
      </Dialog>
      <ThemeProvider theme={customTheme(outerTheme)}>
        {!isSuccess ? (
            ...
            <div className="w-full flex flex-col gap-y-10">
              ...
              <div className="flex items-center">
                ...
                <label
                  ...
                  className="ms-2 text-sm font-medium text-gray-900 text-justify"
                >
                  Potwierdzam, że&nbsp;zapoznałem się i&nbsp;akceptuję{" "}
                  <a
                    href={routes.regulamin}
                    className="text-[#47141e] hover:underline"
                  >
                    regulamin strony
                  </a>{" "}
                  internetowej oraz&nbsp;potwierdzam, że&nbsp;zapoznałem się
                  z&nbsp;
                  <a
          ...
          <div className="w-full h-full flex flex-row justify-center items-center text-xl">
