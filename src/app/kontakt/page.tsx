...
const Menu = [
  {
    label: "Zadzwoń",
    icon: <Phone sx={{ color: "#47141e" }} />,
    text: "Zadzwoń jeśli potrzebujesz pilnej odpowiedzi",
    data: "+48 999 000 222",
  },
  {
    label: "Napisz",
    icon: <Email sx={{ color: "#47141e" }} />,
    text: "Napisz, a odpiszemy",
    data: "biuro@ofkors.pl",
  },
  {
    label: "Przyjedź",
    icon: <Place sx={{ color: "#47141e" }} />,
    text: "Przyjedź i spotkaj się z nami",
    data: "pl. konesera 12\n00-001 Warszawa",
  },
];
    ...
    <>
      ...
      <div className="w-full flex-wrap flex flex-row justify-around my-20 gap-y-10 flex-wrap">
        <Link
          ...
          className="flex flex-col justify-center items-center gap-y-2.5 w-80 h-80 md:w-80 md:h-80 rounded-full bg-[#FAF8F6] p-5 shadow-2xl"
        >
          <div>
            <Phone
              sx={{ color: "#47141e", fontSize: "50px", marginBottom: "10px" }}
            />
          </div>
