    ...
    return (
        <>
            <div className="contact-main-section mt-10">
                <div className="flex items-center flex-col lg:flex-row justify-center m-0 md:m-10 py-10 px-5 md:px-20">
            ...
            <div className="w-full flex-wrap flex flex-row justify-around my-20 gap-y-10 flex-wrap">
                <Link href="tel:+48883027007" className="flex flex-col justify-center items-center gap-y-2.5 w-80 h-80 md:w-80 md:h-80 rounded-full bg-[#FAF8F6] p-5 shadow-2xl">
                    ...
                    <div className="text-center text-md">+48 883 027 007</div>
                </Link>
                <Link href="mailto:biuro@ofkors.pl" className="flex flex-col justify-center items-center gap-y-2.5 w-80 h-80 md:w-80 md:h-80 rounded-full bg-[#FAF8F6] p-5 shadow-2xl">
                ...
                <Link href='https://maps.app.goo.gl/UzjSHtDJddsT4i317' target="blank" className="flex flex-col justify-center items-center gap-y-2.5 w-80 h-80 md:w-80 md:h-80 rounded-full bg-[#FAF8F6] p-5 shadow-2xl">
