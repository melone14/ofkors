    ...
    return (
        ...
        <div className="flex w-full px-10 flex-col lg:flex-row items-center p-5 pb-0 lg:px-10 justify-center gap-10">
            ...
            <div  className="w-full lg:w-1/3 text-justify">
              <div className="mb-5 text-xl">Ofkors Nieruchomości to pasjonaci, którzy połączyli swoje  wieloletnie doświadczenie, wiedzę i energię, aby stworzyć wyjątkowe miejsce na rynku nieruchomości. Nasza otwartość, zaangażowanie i łatwość nawiązywania relacji sprawiają, że budujemy trwałe więzi zarówno z klientami, jak i partnerami biznesowymi. W Ofkors wierzymy, że sukces opiera się nie tylko na umiejętnościach zawodowych, ale także na etyce pracy i indywidualnemu podejściu do każdego klienta. </div>
